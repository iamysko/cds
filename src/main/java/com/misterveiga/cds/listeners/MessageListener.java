...
public class MessageListener extends ListenerAdapter {
	...
	private void executeListMutedUsers(final Message message) {
	...
	private void executeListBannedUsers(final Message message) {
